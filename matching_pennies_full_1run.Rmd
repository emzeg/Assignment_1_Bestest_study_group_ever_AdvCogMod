...
StratSwitcherChoice_against_WSLS_modified <- StratSwitcherChoice_f(Other_Player = WSLSChoice, rate = 0.5)
```
...
WSLS_modified_against_Switch <- WSLSAgent_modified_prob_f(rate = 0.5, Other_Player = StratSwitcherChoice_against_WSLS, switchProbLose = 0.3, switchProbWin = 0.1)
```
...
#final boss
df4 <- df_f(WSLS_switch_Choice, StratSwitcherChoice_against_Random, trials)
plot_f(df4, WSLS_switch_Choice, StratSwitcherChoice_against_Random, trials )


#winning n plot
winning_n_plot(df4, "WSLS modified", "Strategy Switcher", p1_color = "lightpink", p2_color = "#FFC067")

#plotting the win-rate
winrate_plot4 <- plot_winrate_f(df4)
winrate_plot4
```
