...
plot_f <- function(df, player1, player2, trials) {
  plot <- ggplot(df) + 
  theme_classic() + 
  geom_line(color = "red", aes(trials, player1)) + 
  geom_line(color = "blue", aes(trials, player2))
...
```
```{r}
#winrate plot of Random vs WSLS
...
#Shitty plots
```{r}
#plots of stratswitcher against RANDOM
...
```{r}
#plots of stratswitcher against WSLS
